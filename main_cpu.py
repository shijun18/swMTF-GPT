...
cluster = {'chief': ['172.19.12.71:2223'],
           'worker': ['172.19.12.72:2223','172.19.12.73:2223', '172.19.12.74:2223']
          }


# cluster = {'chief': ['172.19.12.71:2222'],
#            'worker': ['172.19.12.74:2222']
#           }

# cluster = {'chief': ['172.19.12.71:2222'],
#             'ps': ['172.19.12.72:2222'],
#             'worker': ['172.19.12.73:2222', '172.19.12.74:2222']
#           }
...
def main(args):
    ...
    if args.check_dataset and args.task == 'chief':
    ...
    if args.predict and args.task == 'chief':
        # Predict
    ...
    if args.eval and args.task == 'chief':
        run_eval_tasks()
    ...
    elif has_predict_or_eval_steps_or_eval_tasks and args.task == 'chief':
